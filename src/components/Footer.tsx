      ...
      <div className="wrap">
        <div className="cols">
          ...
          <div>
            <h5>Resources</h5>
            <ul>
              <li><a href="https://zenodo.org/records/21490478" target="_blank" rel="noopener noreferrer">Whitepaper</a></li>
          ...
          <div>
            ...
            <ul>
              ...
              <li><a href="https://zenodo.org/records/21490478" target="_blank" rel="noopener noreferrer">Zenodo</a></li>
        ...
        <div className="btm">
          ...
          <span>Last updated: 2026-07-22</span>
        </div>
      </div>
    </footer>
  );
